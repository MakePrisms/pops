/* @ts-self-types="./pops_core_verify.d.ts" */
 ...
 * @returns {string}
 */
function build_payment_credential(credentials_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(credentials_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.build_payment_credential(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
exports.build_payment_credential = build_payment_credential;
 ...
 * @returns {string}
 */
function decode_request_object(b64) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(b64, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.decode_request_object(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
exports.decode_request_object = decode_request_object;

/**
 * Encode a JSON `draft-cashu-charge-00` request object as the base64url-nopad
 * JCS-canonical `request="…"` auth-param value.
 * @param {string} request_object_json
 * @returns {string}
 */
function encode_request_object(request_object_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(request_object_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.encode_request_object(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
exports.encode_request_object = encode_request_object;
 ...
 * @returns {string}
 */
function parse_payment_credential(authorization) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(authorization, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.parse_payment_credential(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
exports.parse_payment_credential = parse_payment_credential;
 ...
 * @returns {string}
 */
function parse_payment_params(www_authenticate) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(www_authenticate, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.parse_payment_params(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
exports.parse_payment_params = parse_payment_params;
 ...
 * @param {string} presented_token
 * @param {string} requirement_json
 * @returns {Promise<any>}
 */
function verify_and_redeem(presented_token, requirement_json) {
    const ptr0 = passStringToWasm0(presented_token, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(requirement_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.verify_and_redeem(ptr0, len0, ptr1, len1);
    return ret;
}
exports.verify_and_redeem = verify_and_redeem;
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_new_typed_bf31d18f92484486: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return wasm_bindgen__convert__closures_____invoke__h2f798ac243a762a3(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h8d325648fe728d55);
            return ret;
        },
    ...
    return {
        __proto__: null,
        "./pops_core_verify_bg.js": import0,
    };
}

function wasm_bindgen__convert__closures_____invoke__h8d325648fe728d55(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__h8d325648fe728d55(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

function wasm_bindgen__convert__closures_____invoke__h2f798ac243a762a3(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures_____invoke__h2f798ac243a762a3(arg0, arg1, arg2, arg3);
}
...
const wasmPath = `${__dirname}/pops_core_verify_bg.wasm`;
