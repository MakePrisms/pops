 ...
 * @returns {string}
 */
function decode_request_envelope(b64) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(b64, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.decode_request_envelope(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
exports.decode_request_envelope = decode_request_envelope;
 ...
 * @returns {string}
 */
function encode_request_envelope(creq_a) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(creq_a, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.encode_request_envelope(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
...
exports.encode_request_envelope = encode_request_envelope;
 ...
 * @returns {Promise<any>}
 */
function verify_and_redeem(presented, req_json) {
    const ptr0 = passStringToWasm0(presented, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
        ...
        __wbg_new_typed_bf31d18f92484486: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return wasm_bindgen__convert__closures_____invoke__h52d9b9b7bc281a91(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
...
function wasm_bindgen__convert__closures_____invoke__h52d9b9b7bc281a91(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures_____invoke__h52d9b9b7bc281a91(arg0, arg1, arg2, arg3);
}
